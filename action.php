				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="misavijan-facilitator@gmail.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/MISHRAStore/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/MISHRAStore/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/MISHRAStore/cancel.php"/>
									<input type="hidden" name="currency_code" value="USD"/>
									<input type="hidden" name="custom" value="'.$_SESSION["uid"].'"/>
									<br><br><br><div align="center">
							
										<div class="col-md-12">
										<input style="width:30%;" value="PAYPAL" type="submit" name="submit"class="btn btn-success">
									
									
										<a href="cod.php" class="btn btn-warning" >
